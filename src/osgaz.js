...
/**
 * @fileoverview A class to create a OSGaz autocomplete that will match
 ...
 *
 * More info:
 * http://wiki.openstreetmap.org/wiki/OSGaz
...
goog.provide('goog.ui.AutoComplete.OSGaz');

goog.require('goog.net.Jsonp');
goog.require('goog.ui.AutoComplete');
goog.require('goog.ui.AutoComplete.Basic');
goog.require('goog.ui.AutoComplete.InputHandler');
goog.require('goog.ui.AutoComplete.OSGazMatcher');
 ...
 * @param {string=} opt_url The Uri of the OSGaz service.
 * @param {Object=} opt_payload Extra parameters for the Jsonp request.
 * @constructor
 * @extends {goog.ui.AutoComplete.Basic}
 */
goog.ui.AutoComplete.OSGaz = function(input, opt_url, opt_payload) {
   ...
   * @type {goog.ui.AutoComplete.OSGazMatcher}
   * @private
   */
  var matcher = new goog.ui.AutoComplete.OSGazMatcher(opt_url, opt_payload);
...
goog.inherits(goog.ui.AutoComplete.OSGaz, goog.ui.AutoComplete.Basic);
 ...
 *     matching.
 */
goog.ui.AutoComplete.OSGaz.prototype.search =
